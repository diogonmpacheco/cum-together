...
- **Consent before entry:** every room begins with an explicit adult and consent agreement.
...
- no face requirement
- no contact fields
- no searchable profiles by default
- no follower counts
- no tipping pressure
- no private inbox
- no public archive

The room itself should be the experience. Leaving the room should end the interaction.
...
- membership that funds moderation, infrastructure, and privacy work
- community/group plans for trusted organizers
- paid verification where appropriate
- donations or patron support
- optional paid safety features for hosts, such as larger rooms or stronger moderation tools
